...
export const CATEGORIZACION: CategorizacionEntry[] = [
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'COSECHAR FRUTA CON DEFECTO', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'DEJAR FRUTA EN PLANTA', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'NO REALIZAR MONITOREO DE COSECHADORES (LLENADO DE CARTILLA)', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'EJECUTAR UNA LABOR NO DESIGNADA', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'JABAS MAL LLENADAS', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'ERRORES EN LA PROGRAMACIÓN DE TRANSPORTE DE PERSONAL', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'NO COORDINAR SERVICIOS DE TRANSPORTE DE PERSONAL', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'DEJAR FRUTA EN ACOPIO', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'NO SINCRONIZAR EN EL COMEDOR ASIGNADO', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'SINCRONIZAR LOS ALMUERZOS A DESTIEMPO', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'OTRAS FALTAS DE EJECUCIÓN DEL TRABAJO', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'INCUMPLIR PROCEDIMIENTOS DE TRABAJO', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'INCUMPLIMIENTO DE CALIDAD', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'NO SINCRONIZAR LOS ALMUERZOS', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'SUSPENDER INTEMPESTIVAMENTE LABORES', gravedad: 'ALTO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'PARALIZACIÓN INTEMPESTIVA DE LABORES', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'NO ACATAR CAMBIO DE PUESTO', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'REGISTRAR ASISTENCIA FUERA DE HORA', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'DEJAR FLORES SIN PINTAR (FNP)', gravedad: 'BAJO' },
