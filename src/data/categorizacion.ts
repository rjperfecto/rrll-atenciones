...
// Fuente: "ATENCIONES 2026-ACTUAL.xlsx" (hoja "CATEGORIZACIÓN (2)"), 2026-08-14.
// Reemplaza la versión anterior extraída de ATENCIONES RRLL-2025.xlsx.
...
export const CATEGORIZACION: CategorizacionEntry[] = [
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'ASISTENCIA Y/O PUNTUALIDAD', subcategoria: 'REGISTRAR ASITENCIA SIN HABER LABORADO', gravedad: 'ALTO' },
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'AGREDIR VERBAL Y/O FISICA AL PERSONAL', gravedad: 'ALTO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'DORMIR EN HORARIO DE TRABAJAO', gravedad: 'MEDIO' },
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'ASISITIR EN ESTADO DE EBRIEDAD', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'ASISTIR BAJO INFLUENCIA DE DROGAS', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'PORTAR ARMAS DE FUEGO Y/O PUNZO CORTANTES', gravedad: 'ALTO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'NEGAR BRINDAR EL FOTOCHECK', gravedad: 'MEDIO' },
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'NEGAR FIRMAR O ACEPTAR INCUMPLIMEINTO', gravedad: 'MEDIO' },
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'COMPORTAMIENTO', subcategoria: 'FALTAR DE RESPETO A TRAVÉS DE ACTOS', gravedad: 'MEDIO' },
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'NO RESPETAR LOS LIMITES DE VELOCIDAD VEHICULAR', gravedad: 'BAJO' },
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'INGRESAR O RETIRARSEDE LA EMPRESA POR ZONAS NO AUTORIZADAS, SIN PUNTOS DE CONTROL', gravedad: 'BAJO' },
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'VIAJAR EN LA TOLVA DE VEHICULO NO ASIGNADA PARA TAL FIN', gravedad: 'BAJO' },
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'SUBIR O BAJAR DE VEHICULOS EN MOVIMIENTO', gravedad: 'BAJO' },
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'PERMITIR/ASIGNAR LABORES DE ALTO RIESGO A PERSONAL NO CALIFICADO O ENTRENADO PARA EL MISMO', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'FUMAR EN LUGARES PUBLICOS', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'PERMITIR QUE LOS TRABAJADORES A SU CARGO REALICEN LABORES EN CONDICIONES INSEGURAS O REALIZANDO ACTOS INSEGUROS', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'NO REALIZAR EL PERMISO DE TRABAJO O ANALISIS DE RIESGO ANTES DE EJECUTAR LA LABOR', gravedad: 'BAJO' },
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'NO REALIZAR LA LABOR TENIENDO EN CUENTA EL PERMISO DE TRABAJO O ANALISIS DE RIESGO', gravedad: 'BAJO' },
  ...
  { tipo: 'INTERVENCIÓN', categoria: 'SEGURIDAD Y RIT', subcategoria: 'NO SOMETERSE A EXAMENES MEDICOS', gravedad: 'BAJO' },
  ...
  { tipo: 'RECLAMO', categoria: 'ROTACION DE ZONA/FUNDO POR BAJA OFERTA DE FRUTA', subcategoria: 'ROTACION DE ZONA/FUNDO POR BAJA OFERTA DE FRUTA', gravedad: 'ALTO' },
  ...
  // GESTION LABORAL
  { tipo: 'GESTION LABORAL', categoria: 'PROCESO DE RRLL', subcategoria: 'USO DE APLICATIVOS (BERRYDICTO)', gravedad: 'BAJO' },
  { tipo: 'GESTION LABORAL', categoria: 'TRÁMITES SINDICALES', subcategoria: 'TRÁMITES SINDICALES', gravedad: 'MEDIO' },

  // INCUMPLIMIENTO LABORAL
  { tipo: 'INCUMPLIMIENTO LABORAL', categoria: 'ACTOS CONTRA LA BUENA FE LABORAL', subcategoria: 'MANIPULAR LA INFORMACIÓN EN EL TAREO MÓVIL', gravedad: 'MEDIO' },

  // GESTION DOCUMENTARIA
  { tipo: 'GESTION DOCUMENTARIA', categoria: 'REVISIÓN DE INFORMACIÓN', subcategoria: 'SUNAFIL', gravedad: 'ALTO' },
]
